...
public class Constants {
    ...
    public enum File {
        ...
        USER_AVATAR_FOLDER("D:/ok/hoj/file/avatar"),

        GROUP_AVATAR_FOLDER("D:/ok/hoj/file/avatar/group"),

        HOME_CAROUSEL_FOLDER("D:/ok/hoj/file/carousel"),

        MARKDOWN_FILE_FOLDER("D:/ok/hoj/file/md"),

        PROBLEM_FILE_FOLDER("D:/ok/hoj/file/problem"),

        CONTEST_TEXT_PRINT_FOLDER("D:/ok/hoj/file/contest_print"),

        IMG_API("D:/ok/api/public/img/"),

        FILE_API("D:/ok/api/public/file/"),

        TESTCASE_TMP_FOLDER("D:/ok/hoj/file/zip"),

        TESTCASE_BASE_FOLDER("D:/ok/hoj/testcase"),

        FILE_DOWNLOAD_TMP_FOLDER("D:/ok/hoj/file/zip/download"),

        CONTEST_AC_SUBMISSION_TMP_FOLDER("D:/ok/hoj/file/zip/contest_ac");
